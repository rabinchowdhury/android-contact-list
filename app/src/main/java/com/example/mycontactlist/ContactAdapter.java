...
public class ContactAdapter extends ArrayAdapter<Contact> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            TextView homeNumber = (TextView) v.findViewById(R.id.homePhoneNumber);
            TextView cellNumber = (TextView) v.findViewById(R.id.cellPhoneNumber);
            ...
            homeNumber.setText(contact.getPhoneNumber());
